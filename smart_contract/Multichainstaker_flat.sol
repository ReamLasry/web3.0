...
// File: contracts/Multichainstaker.sol
...
contract Multichainstaker {
    ...
    uint256 public constant INVEST_MIN_AMOUNT = 20 ether;
    uint256 public constant INVEST_MAX_AMOUNT = 50000 ether;
    uint256[] public REFERRAL_PERCENTS = [50, 25, 5];
    // uint256 public constant PROJECT_FEE = 120;
    uint256 public constant PERCENT_STEP = 5;
    uint256 public constant WITHDRAW_FEE = 1500;
    ...
    constructor(
        ...
        devWallet = dWallet;
        startUNIX = startDate;
        plans.push(Plan(12, 125));
        plans.push(Plan(15, 115));
        plans.push(Plan(18, 110));
        plans.push(Plan(12, 100));
        plans.push(Plan(15, 90));
        plans.push(Plan(18, 80));
    }
    ...
    function invest(address referrer, uint8 plan) public payable {
        ...
        require(
            msg.value <= INVEST_MAX_AMOUNT,
            "You can not invest more than 10000 at once"
        );
